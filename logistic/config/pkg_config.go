...
func LoadSharedPackagesConfig() *SharedPackagesConfig {
	...
	return &SharedPackagesConfig{
		Cache: CachePackageConfig{
			...
			ServiceName:   getEnvString("CACHE_SERVICE_NAME", "logistic-service"),
			RedisAddr:     redisAddr,
		...
		Authorization: AuthorizationPackageConfig{
			...
			ServiceName:   getEnvString("AUTHZ_SERVICE_NAME", "logistic-service"),
		...
		CustomFields: CustomFieldsPackageConfig{
			...
			ServiceName:   getEnvString("CUSTOMFIELDS_SERVICE_NAME", "logistic-service"),
