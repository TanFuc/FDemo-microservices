...
func LoadSharedPackagesConfig() *SharedPackagesConfig {
	...
	return &SharedPackagesConfig{
		Cache: CachePackageConfig{
			...
			ServiceName:   getEnvString("CACHE_SERVICE_NAME", "auth-service"),
		...
		Authorization: AuthorizationPackageConfig{
			...
			ServiceName:   getEnvString("AUTHZ_SERVICE_NAME", "auth-service"),
			DefaultTenant: getEnvString("AUTHZ_DEFAULT_TENANT", "default"),
			DBHost:        getEnvString("AUTHZ_DB_HOST", getEnvString("DB_HOST", "localhost")),
			DBPort:        getEnvInt("AUTHZ_DB_PORT", getEnvInt("DB_PORT", 5432)),
			DBUser:        getEnvString("AUTHZ_DB_USER", getEnvString("DB_USERNAME", "postgres")),
			DBPassword:    getEnvString("AUTHZ_DB_PASSWORD", getEnvString("DB_PASSWORD", "postgres")),
			...
			RedisPassword: getEnvString("AUTHZ_REDIS_PASSWORD", getEnvString("REDIS_PASSWORD", "")),
			RedisDB:       getEnvInt("AUTHZ_REDIS_DB", 1),
		},
		CustomFields: CustomFieldsPackageConfig{
			Enabled:       getEnvBool("CUSTOMFIELDS_ENABLED", false),
			ServiceName:   getEnvString("CUSTOMFIELDS_SERVICE_NAME", "auth-service"),
			DefaultTenant: getEnvString("CUSTOMFIELDS_DEFAULT_TENANT", "default"),
			DBHost:        getEnvString("CUSTOMFIELDS_DB_HOST", getEnvString("DB_HOST", "localhost")),
			DBPort:        getEnvInt("CUSTOMFIELDS_DB_PORT", getEnvInt("DB_PORT", 5432)),
			DBUser:        getEnvString("CUSTOMFIELDS_DB_USER", getEnvString("DB_USERNAME", "postgres")),
			DBPassword:    getEnvString("CUSTOMFIELDS_DB_PASSWORD", getEnvString("DB_PASSWORD", "postgres")),
			...
			RedisPassword: getEnvString("CUSTOMFIELDS_REDIS_PASSWORD", getEnvString("REDIS_PASSWORD", "")),
