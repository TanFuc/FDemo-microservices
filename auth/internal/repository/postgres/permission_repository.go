...
func (r *permissionRepository) FindBySlug(ctx context.Context, slug string) (*model.Permission, error) {
	var permission model.Permission
...
func (r *permissionRepository) FindByCategory(ctx context.Context, category string) ([]model.Permission, error) {
	var permissions []model.Permission
	err := r.db.WithContext(ctx).
...
func (r *permissionRepository) Upsert(ctx context.Context, permission *model.Permission) error {
