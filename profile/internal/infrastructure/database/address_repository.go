...
func (r *addressRepository) FindByID(ctx context.Context, id primitive.ObjectID) (*entity.Address, error) {
...
func (r *addressRepository) FindByIDAndUserID(ctx context.Context, id primitive.ObjectID, userID string) (*entity.Address, error) {
	var address entity.Address
	err := r.collection.FindOne(ctx, bson.M{
		"_id":       id,
		"userId":    userID,
...
func (r *addressRepository) FindDefaultByUserID(ctx context.Context, userID string) (*entity.Address, error) {
	var address entity.Address
	err := r.collection.FindOne(ctx, bson.M{
		"userId":    userID,
		"isDefault": true,
...
func (r *addressRepository) FindMostRecentByUserID(ctx context.Context, userID string) (*entity.Address, error) {
