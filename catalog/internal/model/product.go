...
// VariantOption defines options for creating variants
...
type Product struct {
	...
	CategoryPath     string             `bson:"categoryPath" json:"categoryPath"`
	...
	Model3D          string             `bson:"model3d,omitempty" json:"model3d,omitempty"`

	// Pricing
	BasePrice      decimal.Decimal `bson:"basePrice" json:"basePrice"`
	CompareAtPrice decimal.Decimal `bson:"compareAtPrice,omitempty" json:"compareAtPrice,omitempty"`
	CostPrice      decimal.Decimal `bson:"costPrice,omitempty" json:"costPrice,omitempty"`
	MinPrice       decimal.Decimal `bson:"minPrice" json:"minPrice"`
	MaxPrice       decimal.Decimal `bson:"maxPrice" json:"maxPrice"`
	...
	Dimensions     *Dimensions `bson:"dimensions,omitempty" json:"dimensions,omitempty"`
	ShippingClass  string      `bson:"shippingClass" json:"shippingClass"`
