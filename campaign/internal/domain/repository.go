...
type VoucherRepository interface {
	...
	Delete(ctx context.Context, id uuid.UUID) error
	ListByCampaignID(ctx context.Context, campaignID uuid.UUID) ([]*Voucher, error)
}
...
type UserVoucherRepository interface {
	Create(ctx context.Context, userVoucher *UserVoucher) error
	GetByUserAndVoucher(ctx context.Context, userID, voucherID uuid.UUID) (*UserVoucher, error)
	GetByUserID(ctx context.Context, userID uuid.UUID) ([]*UserVoucher, error)
