...
func LoadSharedPackagesConfig() *SharedPackagesConfig {
	...
	return &SharedPackagesConfig{
		Cache: CachePackageConfig{
			...
			ServiceName:   getEnvString("CACHE_SERVICE_NAME", "campaign-service"),
			RedisAddr:     redisAddr,
		...
		Authorization: AuthorizationPackageConfig{
			...
			ServiceName:   getEnvString("AUTHZ_SERVICE_NAME", "campaign-service"),
		...
		CustomFields: CustomFieldsPackageConfig{
			...
			ServiceName:   getEnvString("CUSTOMFIELDS_SERVICE_NAME", "campaign-service"),
